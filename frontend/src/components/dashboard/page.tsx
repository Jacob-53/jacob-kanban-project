...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold">안녕하세요, {user?.username || '사용자'}님!</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          {tasks.length > 0 ? (
              ...
              {tasks.slice(0, 5).map(task => (
                ...
                >
                  <div className="flex justify-between items-center">
                    ...
                    <div>
                      {task.is_delayed && (
                        <span className="bg-red-100 text-red-800 text-xs px-2 py-1 rounded">지연됨</span>
                      )}
                      {task.help_needed && (
            ...
            <p className="text-gray-500 text-center py-4">작업이 없습니다.</p>
          )}
        </div>
